...
class Thrive_Comments_Front {
	...
	public function __construct() {
		...
		add_filter( 'tcb_main_frame_localize', array( $this, 'architect_localize' ), 90 );
	...
	/**
	 * Hook into TAr's localization data
	 *
	 * @param array $parameters
	 *
	 * @return array
	 */
	public function architect_localize( $parameters ) {
		if ( ! empty( $parameters['theme']['is_theme_template'] ) && tcm()->is_active() ) {

			/* if Thrive Comments is active, remove the "Main Settings" for the comments element - the appearance is controlled by TC - just on Theme Templates */
			unset( $parameters['elements']['thrive_comments']['components']['thrive_comments'] );
		}
