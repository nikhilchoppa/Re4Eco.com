	...
	protected function defaults() {
		$defaults = array(
			'link'       => array(
				...
				'selector'    => ':not(.inc) .thrv_text_element a, :not(.inc) .tcb-styled-list a, :not(.inc) .tcb-numbered-list a, .tve-input-option-text a',
				'lp_selector' => '#tcb_landing_page .thrv_text_element a, #tcb_landing_page .tcb-styled-list a, #tcb_landing_page .tcb-numbered-list a, #tcb_landing_page .tve-input-option-text a',
			),
			'p'          => array(
