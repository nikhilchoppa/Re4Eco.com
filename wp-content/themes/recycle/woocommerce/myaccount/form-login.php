...
<?php endif; ?>
		...
		<form class="woocommerce-form woocommerce-form-login login row" method="post">
			...
			<div class="col-md-2">
				...
				<input type="submit" class="btn-block btn btn-md btn-flat btn-c1" name="login" value="<?php esc_attr_e( 'Login', 'woocommerce' ); ?>" />
	...
	<div class="u-column2 col-2">
		...
		<form method="post" class="register">
			...
			<p class="woocomerce-FormRow form-row">
				...
				<input type="submit" class="btn btn-md btn-flat btn-c1" name="register" value="<?php esc_attr_e( 'Register', 'woocommerce' ); ?>" />
			</p>
