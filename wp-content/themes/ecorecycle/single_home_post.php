...
<div class="mainwrap">
	...
	<div class="content singledefult ">
		<div class="postcontent singledefult" id="post-<?php the_ID(); ?>" <?php post_class(); ?>>		
					...
					<?php if ( !has_post_format( 'gallery' , get_the_id())) { ?>
						...
						<div class="blogsingleimage">			
							...
							<?php } 		
									...
									<span><?php the_time('F j, Y') ?></span>  <span><?php echo '<em>' . get_the_category_list( __( ', ', 'ecorecycle' ) ) . '</em>'; ?></span> <a href="#commentform"><?php comments_number(); ?></a>
								</div>	
					...
					<?php } else {?>
						...
						<?php } ?>
							<div class = "meta videoGallery">
								...
								echo pmc_security($post_icon);?>								
								<?php the_time('F j, Y') ?> <?php _e('By ','ecorecycle') ?> <?php echo get_the_author_link() ?> - <a href="#commentform"><?php comments_number(); ?></a>
								</div>	
					<?php }  ?>
					<div class="sentry">
						<?php if ( has_post_format( 'video' , get_the_id())) {?>
			...
			<div class="read-more"><a href="<?php echo get_permalink(get_the_id()) ?>"><?php _e('Read more about this...','ecorecycle'); ?> <?php the_title() ?></a></div>
		</div>		
